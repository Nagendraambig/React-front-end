...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.firstname && (firstname.length >10 || firstname.length<=3))
            errors.firstname = "Characters i the first name should be more than 3 and less than 11";
        if(this.state.touched.lastname && (lastname.length >10 || lastname.length <=3))
            errors.lastname = "Characters in the lastname should be more than 3 and less than 11";
        const reg = /^\d+$/;
                            ...
                            <FormGroup row>
                                ...
                                <Col md={{size:3, offset:1}}>
                                    <Input type="select" name="contactType"
                                        val={this.state.contactType} onChange={this.handleInputChange} >
